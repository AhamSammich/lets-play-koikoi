...
<template>
    <article id="how-to-play" v-if="isOpen">
        <section :class="{ active: currentIndex === 0 }">
            ...
            <img src="~/assets/gifs/lpk-how-to-play-a-card.gif" alt="GIF showing how to play a card" />
        </section>
        <section :class="{ active: currentIndex === 1 }">
            ...
            <img src="~/assets/gifs/lpk-how-to-finish-turn.gif" alt="GIF showing how to play a card" />
        </section>
        ...
        <section :class="{ active: currentIndex === 3 }">
            <div>
                ...
                <p>Your goal is to collect cards to complete a set, called a "yaku", and score points before your opponent.</p>
                <p>Check your progress toward possible yaku using the button below the menu.</p>
            </div>
            <img src="~/assets/gifs/lpk-how-to-check-progress.gif" alt="GIF showing how to play a card" />
        </section>
        <section :class="{ active: currentIndex === 4 }">
            <div>
                <h1>Go big or go home?</h1>
                <p>Upon completing a yaku, you'll be given the option to continue the round (calling "Koi Koi").</p>
                <p>This gives you the opportunity to score more points by improving your yaku or completing more.</p>
            </div>
            <img src="~/assets/gifs/lpk-how-to-call-koikoi.gif" alt="GIF showing how to play a card" />
        </section>
        <section :class="{ active: currentIndex === 5 }">
            ...
            <img src="~/assets/gifs/lpk-how-to-get-wrecked.gif" alt="GIF showing how to play a card" />
        </section>
        ...
        <footer class="flex justify-end gap-12 w-max absolute right-12 bottom-0 text-yellow-100">
            <button :disabled="currentIndex === 0" @click="handlePrev()"><Icon name="mdi:arrow-left" /></button>
            <button :disabled="currentIndex === sectionArr?.length - 1" @click="handleNext()"><Icon name="mdi:arrow-right" /></button>
        </footer>
    </article>
</template>
